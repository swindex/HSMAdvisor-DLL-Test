...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Not Core.isLicense() Then
            Core.ShowLicenseDialog()
        Else
            MsgBox(String.Format(
                "License Level:{0}, Is License {1}? {2}", Core.GetLicenseLevel, License_Level_.Trial.ToString, GetLicenseLevel() = License_Level_.Trial
                ))
        End If
